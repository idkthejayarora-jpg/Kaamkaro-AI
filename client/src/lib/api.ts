...
export const attendanceAPI = {
  ...
  editGrant:    () => api.get('/attendance/edit-grant').then(r => r.data),
  grantEdit:    (hours: number) => api.post('/attendance/edit-grant', { hours }).then(r => r.data),
  revokeEdit:   () => api.delete('/attendance/edit-grant').then(r => r.data),
