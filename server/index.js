...
async function seed() {
  ...
  const collections = ['staff', 'customers', 'vendors', 'performance', 'interactions', 'tasks', 'diary', 'auditLog', 'goals', 'templates', 'broadcasts', 'attendance', 'vendorInteractions', 'config'];
